...
if (!is_admin($current_user)) {
	...
	$menu_array['DCL_CHANGE_MODULE_STATUS']['location'] = 'index.php?module=PriceArrangement&action=PriceArrangementConfig&parenttab=Settings&formodule=PriceArrangement';
	$menu_array['DCL_CHANGE_MODULE_STATUS']['image_src'] = 'modules/PriceArrangement/settings.png';
