...
if (isset($_REQUEST['pdo'])) {
	...
	include_once 'modules/PriceArrangement/PriceArrangement.php';
	$prices = PriceArrangement::getDiscount($pdoid, $accid, $ctoid, 0);
}
...
<input name="module" type="hidden" value="PriceArrangement">
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0" class="small">
<tbody><tr><td style="height:2px"></td></tr>
<tr>
	<td>
	<div class="slds-media__figure">
	<a class="hdrLink" href="index.php?action=ListView&module=PriceArrangement">
	<span class="slds-icon_container slds-icon-standard-account" title="<?php echo getTranslatedString('PriceArrangement', 'PriceArrangement'); ?>">
	...
	<?php echo getTranslatedString('PriceArrangement', 'PriceArrangement').'&nbsp;-&nbsp;'.getTranslatedString('Test', 'GlobalVariable');?>
	</a>
	</div>
	</td>
</tr>
...
<?php
$valinfo = PriceArrangement::getValidationInfo();
