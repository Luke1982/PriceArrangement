...
if (!is_admin($current_user)) {
	...
	<form name="myform" role='form' action="index.php" method="POST">
		<input type="hidden" name="module" value="PriceArrangement">
		<input type="hidden" name="action" value="PriceArrangementConfig">
		<input type="hidden" name="parenttab" value="Settings">
		<input type="hidden" name="formodule" value="PriceArrangement">
